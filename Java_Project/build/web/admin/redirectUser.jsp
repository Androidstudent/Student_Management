...
<head>
    ...
    <div id="content">
        ...
        <%--  <a href="addAdminUser.jsp" class="myButton"> ADD Admin</a> &nbsp; <a href="addInstructorUser.jsp" class="myButton">Add Instructor </a> &nbsp; <a href="addStudentUser.jsp" class="myButton"> Add Student </a> &nbsp;
        <a href="#" class="myButton"> GET </a> &nbsp;--%>
        <form name="studentUser" id="studentUser" class="butcls1" action="<%=request.getContextPath()%>/LogInServlet" method="post">
            <input type="hidden" name="check" value="SU1"/>
            <input type="button" name="details" class="myButton" onclick="document.getElementById('studentUser').submit();" value="Add Students Users">
        </form>
        <form name="instUser" id="instUser" class="butcls1" action="<%=request.getContextPath()%>/LogInServlet" method="post">
            <input type="hidden" name="check" value="IN1"/>
            <input type="button" name="add" class="myButton" onclick="document.getElementById('instUser').submit();" value="Add Instructor Users">
        </form>

        <form name="adminUser" id="adminUser" class="butcls1" action="<%=request.getContextPath()%>/LogInServlet" method="post">
            <input type="hidden" name="check" value="AD1"/>
            <input type="button" name="add" class="myButton" onclick="document.getElementById('adminUser').submit();" value="Add Admin Users">
        </form> 
        <div id="content-left">	
            <div class="rain">
